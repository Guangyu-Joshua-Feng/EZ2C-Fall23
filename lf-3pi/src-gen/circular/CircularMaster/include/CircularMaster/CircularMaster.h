...
/*Correspondence: Range: [(10, 2), (25, 22)) -> Range: [(0, 0), (15, 22)) (verbatim=true; src=/home/ee149/EZ2C-Fall23/lf-3pi/src/circular/CircularMaster.lf)*/#include <stdio.h>
...
#endif
typedef struct circularmaster_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    bool discover_done;
    int end[0]; // placeholder; MSVC does not compile empty structs
} circularmaster_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
