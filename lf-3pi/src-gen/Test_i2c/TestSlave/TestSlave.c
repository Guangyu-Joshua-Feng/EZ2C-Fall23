...
// file://home/foobar/EZ2C-Fall23/lf-3pi/src/Test_i2c/TestSlave.lf
#define LOG_LEVEL 2
#define TARGET_FILES_DIRECTORY "/home/foobar/EZ2C-Fall23/lf-3pi/src-gen/Test_i2c/TestSlave"
...
void _lf_create_environments() {
    environment_init(&envs[testslave_main],testslave_main,_lf_number_of_workers,0,1,0,0,0,0,0,NULL);
}
...
void _lf_initialize_trigger_objects() {
    ...
    _testslave_main_main_self_t* testslave_main_self[1];
    SUPPRESS_UNUSED_WARNING(testslave_main_self);
    // ***** Start initializing TestSlave of class TestSlave
    testslave_main_self[0] = new__testslave_main();
    testslave_main_self[0]->base.environment = &envs[testslave_main];
    bank_index = 0; SUPPRESS_UNUSED_WARNING(bank_index);
    envs[testslave_main].startup_reactions[startup_reaction_count[testslave_main]++] = &testslave_main_self[0]->_lf__reaction_0;
    SUPPRESS_UNUSED_WARNING(_lf_watchdog_count);
    
    testslave_main_self[0]->_lf__reaction_0.deadline = NEVER;
    //***** End initializing TestSlave
    // **** Start deferred initialize for TestSlave
    {
    
        // Total number of outputs (single ports and multiport channels)
        // produced by reaction_0 of TestSlave.
        testslave_main_self[0]->_lf__reaction_0.num_outputs = 0;
        {
            int count = 0; SUPPRESS_UNUSED_WARNING(count);
        }
        
        // ** End initialization for reaction 0 of TestSlave
    
    }
    // **** End of deferred initialize for TestSlave
    // **** Start non-nested deferred initialize for TestSlave
    
    
    
    // **** End of non-nested deferred initialize for TestSlave
    // Connect inputs and outputs for reactor TestSlave.

    
    // Set reaction priorities for ReactorInstance TestSlave
    {
        testslave_main_self[0]->_lf__reaction_0.chain_id = 1;
        // index is the OR of level 0 and 
        // deadline 9223372036854775807 shifted left 16 bits.
        testslave_main_self[0]->_lf__reaction_0.index = 0xffffffffffff0000LL;
    }
