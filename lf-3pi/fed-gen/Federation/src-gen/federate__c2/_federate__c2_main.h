#ifndef _FEDERATE__C2_MAIN_H
#define _FEDERATE__C2_MAIN_H
...
} _federate__c2_main_main_self_t;
_federate__c2_main_main_self_t* new__federate__c2_main();
#endif // _FEDERATE__C2_MAIN_H
