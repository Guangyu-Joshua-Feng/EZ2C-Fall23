...
void _networksender_0nullreaction_function_0(void* instance_args) {
    ...
    #line 48 "/home/foobar/EZ2C-Fall23/lf-3pi/fed-gen/federation/src/federate__c.lf"
...
void _networksender_0nullreaction_function_1(void* instance_args) {
    ...
    #line 57 "/home/foobar/EZ2C-Fall23/lf-3pi/fed-gen/federation/src/federate__c.lf"
    // Sending from msg in federate federate__c to p.in in federate federate__p
    if (!msg->is_present) {
    return;
    }
    size_t _lf_message_length = sizeof(int);
    send_timed_message(self->base.environment, NEVER, MSG_TYPE_TAGGED_MESSAGE, 0, 1, "federate 1 via the RTI", _lf_message_length, (unsigned char*)&msg->value);
}
#include "include/api/set_undef.h"
#include "include/api/set.h"
void _networksender_0nullreaction_function_2(void* instance_args) {
    ...
    _networksender_0null_msg_t* msg = self->_lf_msg;
    int msg_width = self->_lf_msg_width; SUPPRESS_UNUSED_WARNING(msg_width);
    #line 66 "/home/foobar/EZ2C-Fall23/lf-3pi/fed-gen/federation/src/federate__c.lf"
    ...
    LF_PRINT_LOG("The output port is NULL or it is not present.");
        send_port_absent_to_federate(self->base.environment, NEVER, 0, 1);
    }
}
#include "include/api/set_undef.h"
